...
go test ./tests/SQLLogic/... -v

# Run a specific file category
go test ./tests/SQLLogic/... -run "TestSQLLogic/basic"
go test ./tests/SQLLogic/... -run "TestSQLLogic/joins"
go test ./tests/SQLLogic/... -run "TestSQLLogic/aggregates"
```
