    ...
    case SVDB_BC_MOD: {
        ...
        if (use_float) {
            ...
            if (opcode == SVDB_BC_ADD) result = lv + rv;
                ...
                if (rv == 0.0) { dest.val_type = 0; dest.int_val = 0; dest.real_val = 0.0; break; }
                result = lv / rv;
            }
            /* MOD on floats produces NULL (SQL semantics) */
            else { dest.val_type = 0; dest.int_val = 0; dest.real_val = 0.0; break; }
            ...
            if (opcode == SVDB_BC_ADD) result = li + ri;
                ...
                if (ri == 0) { dest.val_type = 0; dest.int_val = 0; dest.real_val = 0.0; break; }
                result = li / ri;
            }
            else {
                if (ri == 0) { dest.val_type = 0; dest.int_val = 0; dest.real_val = 0.0; break; }
