...
| E071 | Subqueries | 7 | 105 | 59 | 56% | Partial |
...
- ✅ **E071 Subqueries (Phase 1)** - Implemented IN/NOT IN/EXISTS/NOT EXISTS with subqueries (56% pass rate)
...
### Detailed E071 Subquery Status (56% complete)
**✅ Implemented (Phase 1)**:
- IN/NOT IN with subqueries - fully working
- EXISTS/NOT EXISTS - fully working  
- Scalar subqueries in SELECT, WHERE, ORDER BY - working
...
- **Scalar in HAVING**: Subqueries in HAVING clause need special handling
- **Nested Subqueries**: Some complex nested patterns fail
