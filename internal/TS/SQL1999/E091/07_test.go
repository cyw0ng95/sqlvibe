...
func TestSQL1999_F301_E09107_L1(t *testing.T) {
	...
	SQL1999.CompareExecResults(t, sqlvibeDB, sqliteDB, "CREATE TABLE t2 (b INTEGER, c TEXT)", "CreateTable2")
	...
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT * FROM t1 NATURAL JOIN t2", "NaturalJoin")
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT * FROM t1 NATURAL LEFT JOIN t2", "NaturalLeftJoin")
}
