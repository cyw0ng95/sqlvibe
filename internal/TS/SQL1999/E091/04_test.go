...
func TestSQL1999_F301_E09104_L1(t *testing.T) {
	...
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT * FROM t1 RIGHT OUTER JOIN t2 ON t1.a = t2.x", "RightOuterJoin")
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT * FROM t1 RIGHT JOIN t2 ON t1.a = t2.x", "RightJoin")
}
