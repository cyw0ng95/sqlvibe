...
func TestSQL1999_F301_E09106_L1(t *testing.T) {
	...
	SQL1999.CompareExecResults(t, sqlvibeDB, sqliteDB, "INSERT INTO t2 VALUES (1, 'world'), (2, 'foo')", "Insert2")
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT * FROM t1 CROSS JOIN t2", "CrossJoin")
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT * FROM t1 CROSS JOIN t2 ON t1.a = t2.x", "CrossJoinOn")
}
