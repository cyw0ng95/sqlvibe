...
func TestSQL1999_F301_E09103_L1(t *testing.T) {
	...
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT * FROM t1 LEFT OUTER JOIN t2 ON t1.a = t2.x", "LeftOuterJoin")
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT * FROM t1 LEFT JOIN t2 ON t1.a = t2.x", "LeftJoin")
}
