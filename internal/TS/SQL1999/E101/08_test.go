...
func TestSQL1999_F301_E10108_L1(t *testing.T) {
	...
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT a + 10 FROM t1", "SelectExpr")
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT a * 2 + 5 FROM t1", "SelectExprComplex")
}
