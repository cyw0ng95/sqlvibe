...
func TestSQL1999_F301_E10102_L1(t *testing.T) {
	...
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT DISTINCT a FROM t1", "SelectDistinct")
	SQL1999.CompareQueryResults(t, sqlvibeDB, sqliteDB, "SELECT DISTINCT a * 2 FROM t1", "SelectDistinctExpr")
}
